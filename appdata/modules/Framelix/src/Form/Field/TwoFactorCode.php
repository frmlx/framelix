...
{
    public const SESSIONNAME_SECRET = 'framelix-2fa-secret';
    public const SESSIONNAME_BACKUPCODES = 'framelix-2fa-backupcodes';
    public const SESSIONNAME_USERID = 'framelix-2fa-userid';
    public const SESSIONNAME_USERSTAY = 'framelix-2fa-stay';
    ...
    public function validate(): string|bool
    {
        ...
        $valid = false;
        $secret = Session::get(self::SESSIONNAME_SECRET);
        ...
        $backupCodes = Session::get(self::SESSIONNAME_BACKUPCODES);
