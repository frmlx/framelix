...
class ImageUtils
{
     ...
     * @param bool $trimWhitespaceAround If true, it will remove all empty border around the content (Useful to extract a single image out of pdf)
     ...
     * Passing 0 to $treshold means 100% exact the same, this only will work for PNG images, JPG have always different noise in it
     * @param string $imagePathExpected
     * @param string $imagePathActual
     * @param float $threshold The difference in pixel percentage from 0 to 1 (1 = 100% difference, 0 = exact same image)
     * @return bool
     */
