...
class FramelixToast {
  ...
  static async showNext(force) {
    ...
    const message = (_await$FramelixLang$g = await FramelixLang.get(row.message)) !== null && _await$FramelixLang$g !== void 0 ? _await$FramelixLang$g : '';
    if (row.delay === 'auto') {
      delay = 5000;
